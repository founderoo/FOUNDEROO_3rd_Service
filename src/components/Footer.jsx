...
// }
// import React, { useState } from 'react';
// import { Mail, MapPin, Linkedin, MessageCircleCode, Rocket } from 'lucide-react';
...
//                 { label: 'About Us', href: '#' },
//                 { label: 'Our Team', href: '#' },
//                 { label: 'Careers', href: 'https://tally.so/r/wMQk60', external: true },
//                 { label: 'Blog', href: '#' },
//                 { label: 'Newsletter', href: 'https://www.linkedin.com/newsletters/the-founder-s-signal-7338714487572570114', external: true },
...
//               </div>
//               <div className="flex items-center space-x-3">
//                 <MessageCircleCode size={16} className="text-purple-400 flex-shrink-0" />
//                 <a
