...
// // import coderAnimation from '../animations/coder-animation.json'; // Adjust path if needed
...
// import { X } from 'lucide-react';
// import Lottie from 'lottie-react';
// import LottieFiles from '../animations/LottieFiles.json'; // Make sure the path is correct
...
// import { X } from 'lucide-react';
// import Lottie from 'lottie-react';
// import animationData from '../animations/LottieFiles.json'; // Path confirm karo

// export default function ComingSoonModal({ onClose }) {
//   return (
//     <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center px-4">
//       <div className="bg-gray-900 text-white rounded-lg max-w-md w-full relative p-8 text-center border border-gray-800">
...
//         {/* Animation Container - Yeh important part hai */}
...
export default function ComingSoonModal({ onClose }) {
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center px-4">
      {/* Yeh line change karo - bg-white/50 ko bg-black/90 se replace karo */}
