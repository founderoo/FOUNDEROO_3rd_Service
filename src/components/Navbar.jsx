  ...
  return (
    <header className="border-b bg-primary text-primary-foreground fixed top-0 w-full z-50">
        ...
        <div className="flex items-center gap-4">
          <nav className="flex items-center gap-6">
            <div className="md:flex items-center gap-6 hidden">
              ...
              <span className="text-sm font-medium text-white font-satoshi cursor-default">
                Founder
              </span>
              <span className="text-sm font-medium text-white font-satoshi cursor-default">
                What We Offer
      ...
      <div className={`md:hidden ${mobileMenuOpen ? 'block' : 'hidden'} bg-primary pb-4`}>
        <div className="space-y-1 px-4">
          {/* Disabled: Non-functional */}
          <span className="block text-sm font-medium font-satoshi py-2 text-white cursor-default">
            Founder
          </span>
          <span className="block text-sm font-medium font-satoshi py-2 text-white cursor-default">
            What We Offer
