...
//   // Team members (excluding founder)
//   const teamMembers = [
//     {
//       name: "Tannu Priya",
//       role: "CPO",
...
//             {/* Startup Planner */}
//             <div className="flex items-start gap-4 p-6 bg-white/50 dark:bg-gray-800/80 rounded-lg backdrop-blur-sm">
...
//               }
//             ].map((step) => (
//               <Card key={step.step} className="relative group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg dark:bg-gray-900">
...
//               <Card key={index} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-border/50 shadow-lg bg-card/95 backdrop-blur-sm dark:bg-gray-900">
//                 <CardHeader className="text-center">
...
//           <div className="flex justify-center">
//             <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-border/50 shadow-lg overflow-hidden bg-card/95 backdrop-blur-sm max-w-2xl dark:bg-gray-900">
...
//               <Card key={index} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-border/50 shadow-lg overflow-hidden bg-card/95 backdrop-blur-sm dark:bg-gray-900">
//                 <div className="relative">
//                   <div className="absolute inset-0 bg-primary/10 group-hover:bg-primary/20 transition-all duration-500"></div>
//                   <CardHeader className="text-center relative z-10">
...
//             {faqs.map((faq, index) => (
//               <Card key={index} className="transition-all duration-300 hover:shadow-lg border border-border/50 shadow-md bg-card/95 backdrop-blur-sm dark:bg-gray-900">
//                 <CardHeader
...
//           <Card className="border border-border/50 shadow-lg bg-card/95 backdrop-blur-sm dark:bg-gray-900">
//             <CardHeader>
...
export default function Home() {
  ...
  <button
    onClick={handleApplyNow}
    className="bg-primary text-primary-foreground px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform transition-all duration-200 rounded-lg flex items-center gap-2 
      hover:-translate-y-1 hover:scale-105 hover:bg-yellow-400 hover:text-black"
  >
    Get Started
    <ArrowRight className="h-5 w-5" />
  </button>
