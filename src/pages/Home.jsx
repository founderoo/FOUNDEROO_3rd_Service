...
//   return (
//     <div className="min-h-screen relative dark:bg-black">
//       {/* Chat Button - Updated with better styling */}
//       <button
//         onClick={() => setIsChatOpen(true)}
//         className="fixed bottom-6 right-6 bg-primary text-primary-foreground p-4 rounded-full shadow-xl hover:bg-primary/90 transition-all duration-300 z-50 flex items-center justify-center"
//         aria-label="Open Chat"
//       >
...
//       {/* Hero Section */}
//       <section className="relative overflow-hidden min-h-[600px] bg-gradient-to-br from-primary/5 to-secondary/5 dark:from-black dark:to-gray-900">
//         <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
//           <div className="text-center flex flex-col items-center justify-center min-h-[400px]">
//             <h1 className="text-[2.5rem] sm:text-[3.5rem] lg:text-[4rem] font-bold mb-6">
//               <div className="text-foreground dark:text-white">The Operating System</div>
...
//               <button
//                 onClick={handleApplyNow}
//                 className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 rounded-lg flex items-center gap-2"
//               >
//                 Get Started
//                 <ArrowRight className="h-5 w-5" />
//               </button>
...
//               <div 
//                 key={i} 
//                 className="flex items-start gap-4 p-6 bg-white/50 dark:bg-black/80 rounded-lg backdrop-blur-sm border border-border/30 hover:border-primary/50 transition-all duration-300"
//               >
//                 <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
//                   {feature.icon}
//                 </div>
...
//               <Card 
//                 key={step.step} 
//                 className="relative group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg dark:bg-black/90"
//               >
//                 <CardHeader className="text-center">
//                   <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-primary-foreground text-2xl font-bold mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
//                     {step.step}
...
//               <Card 
//                 key={index} 
//                 className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-border/50 shadow-lg bg-card/95 backdrop-blur-sm dark:bg-black/90"
//               >
//                 <CardHeader className="text-center">
//                   <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-2xl mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
//                     {testimonial.avatar ? (
...
//                     ) : <User />}
//                   </div>
//                   <CardTitle className="text-2xl font-bold group-hover:text-primary transition-colors duration-300 dark:text-white">
//                     {founder.name}
//                   </CardTitle>
...
//               </div>
//               <CardContent className="space-y-4">
//                 <p className="text-muted-foreground dark:text-gray-300 text-base leading-relaxed text-center">
//                   {founder.description}
//                 </p>
//                 <div className="flex flex-wrap gap-1 justify-center">
//                   {founder.expertise.map((skill, skillIndex) => (
...
//               <Card 
//                 key={index} 
//                 className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-border/50 shadow-lg overflow-hidden bg-card/95 backdrop-blur-sm dark:bg-black/90"
//               >
//                 <div className="relative">
//                   <div className="absolute inset-0 bg-primary/10 group-hover:bg-primary/20 transition-all duration-500"></div>
//                   <CardHeader className="text-center relative z-10">
...
//                       ) : <User />}
//                     </div>
//                     <CardTitle className="text-xl font-bold group-hover:text-primary transition-colors duration-300 dark:text-white">
//                       {member.name}
//                     </CardTitle>
...
//                 </div>
//                 <CardContent className="space-y-4">
//                   <p className="text-muted-foreground dark:text-gray-300 text-sm leading-relaxed text-left">
//                     {member.description}
//                   </p>
//                   <div className="flex flex-wrap gap-1 justify-start">
//                     {member.expertise.map((skill, skillIndex) => (
...
//               <Card 
//                 key={index} 
//                 className="transition-all duration-300 hover:shadow-lg border border-border/50 shadow-md bg-card/95 backdrop-blur-sm dark:bg-black/90"
//               >
//                 <CardHeader
//                   className="cursor-pointer hover:bg-muted/50 transition-colors duration-200 dark:hover:bg-gray-800"
//                   onClick={() => toggleFaq(index)}
...
//             size="lg" 
//             variant="secondary" 
//             className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
//             onClick={handleApplyNow}
//           >
//             Pay ₹499 & Apply Now
//             <ArrowRight className="ml-2 h-5 w-5" />
    ...
    <div className="min-h-screen relative dark:bg-black">
      ...
      <section className="relative overflow-hidden min-h-[600px] bg-primary/5 dark:bg-black">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 max-w-4xl mx-auto">
            <div className="flex items-start gap-4 p-6 bg-white/50 dark:bg-black/80 rounded-lg backdrop-blur-sm">
              <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                <div className="grid grid-cols-2 gap-1">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">Startup Planner</h3>
                <p className="text-muted-foreground dark:text-gray-300">Map out your business model and startup roadmap</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-white/50 dark:bg-black/80 rounded-lg backdrop-blur-sm">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">Founder Docs</h3>
                <p className="text-muted-foreground dark:text-gray-300">Generate and manage your key startup documents</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-white/50 dark:bg-black/80 rounded-lg backdrop-blur-sm">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">Tasks</h3>
                <p className="text-muted-foreground dark:text-gray-300">Organize and track your to-dos and milestones</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-white/50 dark:bg-black/80 rounded-lg backdrop-blur-sm">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">Ask Founderoo</h3>
                <p className="text-muted-foreground dark:text-gray-300">Get answers and advice from our AI assistant</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-muted/50 dark:bg-black/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border border-border/50 shadow-lg bg-card/95 backdrop-blur-sm dark:bg-black/90">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-center dark:text-white">Terms & Conditions</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground dark:text-gray-300">The ₹499 application fee is non-refundable and covers the cost of reviewing your application. This fee ensures that we receive serious applications and can dedicate proper time to evaluate each one.</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2 flex items-center dark:text-white">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                ...
                <p className="text-muted-foreground dark:text-gray-300">If shortlisted, the ₹1,999 interview fee is required to proceed to the final stage. 50% (₹999.50) will be refunded if your startup is not selected after the interview process.</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2 flex items-center dark:text-white">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                ...
                <p className="text-muted-foreground dark:text-gray-300">Selection is based on the viability of your idea, market potential, and founder capabilities. All decisions made by the Founderoo investment committee are final.</p>
              </div>
